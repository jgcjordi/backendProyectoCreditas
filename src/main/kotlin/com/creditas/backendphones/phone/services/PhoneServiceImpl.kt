...
class PhoneServiceImpl : IPhoneService {
    ...
    override fun setPhonesExample() {
        ...
        val color37 = ColorPhone(null, "Black", phone13)
        val color38 = ColorPhone(null, "Blue", phone13)
        val color39 = ColorPhone(null, "Red", phone13)
        colorPhoneDao.save(color37)
        colorPhoneDao.save(color38)
        colorPhoneDao.save(color39)

        val phone14 = Phone(null, "Asus", "ROG Phone 2 ", "https://cdn.phonehouse.es/res/products-image/3/4/6/5/3/346535-0.jpg", "Finding the best price for the Asus ROG Phone 2 is no easy task. Here you will find where to buy the Asus ROG Phone 2 at the best price. Prices are continuously tracked in over 140 stores so that you can find a reputable dealer with the best price", listOf(), listOf())
        phoneDao.save(phone14)
        val version25 = VersionPhone(null, 852F, 8, 128, phone14)
        versionPhoneDao.save(version25)
        val color40 = ColorPhone(null, "Gray", phone14)
        colorPhoneDao.save(color40)

        val phone15 = Phone(null, "Google", "Pixel 3", "https://cdn.phonehouse.es/res/product450/resource_1585992.jpg", "Finding the best price for the Google Pixel 3 is no easy task. Here you will find where to buy the Google Pixel 3 at the best price. Prices are continuously tracked in over 140 stores so that you can find a reputable dealer with the best price", listOf(), listOf())
        ...
        val color41 = ColorPhone(null, "Pink", phone15)
        val color42 = ColorPhone(null, "Black", phone15)
        colorPhoneDao.save(color41)
        colorPhoneDao.save(color42)

        val phone16 = Phone(null, "Google", "Pixel 3 XL", "https://cdn.phonehouse.es/res/product450/resource_1586585.jpg", "Finding the best price for the Google Pixel 3 XL is no easy task. Here you will find where to buy the Google Pixel 3 XL at the best price. Prices are continuously tracked in over 140 stores so that you can find a reputable dealer with the best price", listOf(), listOf())
        ...
        val color48 = ColorPhone(null, "Black", phone18)
        val color49 = ColorPhone(null, "Blue", phone18)
        val color50 = ColorPhone(null, "White", phone18)
